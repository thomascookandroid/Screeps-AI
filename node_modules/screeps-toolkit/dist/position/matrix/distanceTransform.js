 ...
 */
export function applyDistanceTransform(cm, oob = 255) {
 ...
 */
export function getRoomTerrainMatrix(roomName, plain = 1, swamp = 5, wall = MATRIX_MAX, exclude) {
 ...
 */
export function getRoomDistanceTransform(roomName, exclude) {
    return applyDistanceTransform(getRoomTerrainMatrix(roomName, 1, 1, 0, exclude));
}
//# sourceMappingURL=distanceTransform.js.map