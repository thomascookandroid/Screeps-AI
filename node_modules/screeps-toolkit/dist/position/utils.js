 ...
 */
export function isExit(at, range = 0) {
    const { x, y } = at;
 ...
 */
export function normalizePos(it) {
 ...
 */
export function getRoomNameCoords(roomName) {
 ...
 */
export function getRoomSectorKind(name) {
    if (name == "sim")
 ...
 */
export const getRoomCenter = (name) => new RoomPosition(ROOM_SIZE / 2, ROOM_SIZE / 2, name);
/**
 ...
 */
export function getChebyshevDist(a, b) {
 ...
 */
export function getEuclidDist(a, b) {
 ...
 */
export function getDirectionTo(from, to) {
 ...
 */
export function getToDirection(pos, d, n = 1) {
 ...
 */
export function clampInRoom(at) {
    const { x, y } = at;
 ...
 */
export function* inRoomRange(center, range = 1) {
 ...
 */
export function* inRoomRangeXY(center, range = 1) {
 ...
 */
export function inRoomRangeArea(center, range = 1) {
    const { x, y } = center;
    return [
 ...
 * @yields a valid position
 */
export function* atRoomRange(center, range = 1) {
    if (!range) {
        yield center;
        return;
    }
 ...
 */
export const getDirectionsSorted = (d) => [
    d,
    rotateDirection(d, 1),
    rotateDirection(d, -1),
    rotateDirection(d, 2),
