 ...
 */
export function adjustedCPULimit(target = CPU_BUCKET_MAX * 0.8, maxCpuPerTick = 495, limit = Game.cpu.limit, bucket = Game.cpu.bucket) {
    let multiplier = 1;
    if (bucket < target) {
...
//# sourceMappingURL=adjustedCpuLimit.js.map