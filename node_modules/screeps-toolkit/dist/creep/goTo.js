...
import { getDirectionTo, getDirectionsSorted, getToDirection, isExit, normalizePos, } from "../position/utils";
import { isObjectObstacle } from "../room/object";
import { lookForInRange } from "../room/find";
import { getRoomMatrix } from "../room/matrix";
 ...
 */
export function findGoToPath(from, to, opts, roomMatrixCache = {}) {
 ...
 */
export function getGoToPath(c, to, getMemory, limit) {
    if (!c.my)
        return [];
 ...
 * @returns status code
 */
export function goTo(c, target, getMemory, roomMatrixCache = {}, opts = {}) {
