import { ACTION_BODYPART, ACTION_POWER, MOVE_FATIGUE_POWER } from "./constants";
/**
 ...
 */
export const getActiveBodypartsBoostEquivalent = (body, action) => getBodypartsBoostEquivalent(body, action, true);
/**
 ...
 */
export function getMoveEfficiency(creep, usedCapacity = creep.store.getUsedCapacity()) {
    if (!("body" in creep))
 ...
 */
export function getBodypartsPower(body, action) {
