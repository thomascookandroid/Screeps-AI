 ...
 */
export const getGclCumulatedProgress = () => getGxlCumulatedProgress(Game.gcl, GCL_POW, GCL_MULTIPLY);
/**
 * Compute total global power progress {@link Game.gpl} ignoring levels.
 * @returns total global power progress
 */
export const getGplCumulatedProgress = () => getGxlCumulatedProgress(Game.gpl, POWER_LEVEL_POW, POWER_LEVEL_MULTIPLY);
 ...
 */
export function getControllerCumulatedProgress(ctrl) {
 ...
 */
export function getLevelWithProgress(it) {
